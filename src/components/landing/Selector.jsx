...
export default function Selector() {
  ...
  <div class="lg:px-16 max-w-7xl md:px-12 mx-auto px-8 py-24 scroll-mt-12">
      ...
      <span class="pt-8 text-center max-w-3xl mx-auto inline-flex rounded-md shadow-sm">
        <button
          ...
          className={clsx(
            ...
            selectedTab === 'monthly' ? 'bg-white text-gray-900 ring-gray-300 hover:bg-gray-50' : '',
            )}>
          Monthly
        </button>
        <button
          ...
          class={clsx(
            ...
            selectedTab === 'yearly' ? 'bg-white text-gray-900 ring-gray-300 hover:bg-gray-50' : '',
          )}>
          Yearly
        </button>
        <button
          ...
          class={clsx(
            ...
            selectedTab === 'lifetime' ? 'bg-white text-gray-900 ring-gray-300 hover:bg-gray-50' : '',
          )}>
          Lifetime
        </button>
      </span>
    ...
    >
      <section class="free flex flex-col order-first px-6 py-8 rounded-3xl sm:px-8 bg-gray-300 lg:order-none">
